//We want to merge this base code with the .y file that we made (just move over the functions)
//Also the NUMBER represents our float, Woodring says that we should essentially consider all numbers as floats
//So we will likely have to change our .l file to take all numbers
%{
#define WIDTH 640
#define HEIGHT 480
